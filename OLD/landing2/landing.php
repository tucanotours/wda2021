			...
			<div class="row justify-content-between">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<div id="streaming-controles" style="display:none;">
						...
						<p>Si pausas el evento, podes retomar la transmision directa refrescando la pagina.</a>
					</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<ul class="lightSlider">
					...
					array("Air Canada","aircanada.png","", "(air_canada)_AC_Tucano_Workshop_17DEC20.ppt", ""),
					...
					array("Boa","boa.png","", "", "Boa-converted-compressed.pdf"),
  ...
  <div class="modal-dialog" role="document">
	   ...
	   <div class="modal-content">
		  ...
		  <div class="modal-body" style="background:#fff;">
				<p>Gracias <b><?php echo $_GET['nombre']; ?></b>!<br />
				Tus datos personales fueron cargados con éxito. Te invitamos en breve a participar de nuestro evento virtual.</p>
		  </div>
...
$(document).ready(function() {
	...
	$('.lightSlider li a').click(function(){
		...
		if (ppt!="") { 
			var codigo_video = '<iframe src="https://view.officeapps.live.com/op/embed.aspx?src=https://workshopdeaereos.com.ar/landing2/assets/ppt/'+ppt+'" width="962px" height="565px" frameborder="0"></iframe>';
