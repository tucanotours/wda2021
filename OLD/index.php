...
<main>
	...
	<div class="container-fluid tuc-counter">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-12 col-sm-12 tuc-logo-workshop">
	...
	<div class="container-fluid tuc-registro">
	
		<div class="container">
		
			<div class="row">
			
				<div class="tuc-sidebar">
			
					<h1 data-aos="fade-in">Workshops Aéreos - Edición Virtual</h1>
					<h2 data-aos="flip-up">17 DE DIC</h2>
					<h3 data-aos="flip-up">10 AM</h3>
					<h4 data-aos="fade-in">Tucano Tours</h4>
...
?>
<!-- Modal de login -->
<div class="modal" id="tuc_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
   
	   <div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel">Gracias <b><?php echo $_GET['nombre']; ?></b>!</h5>
			<button type="button" class="close" data-dismiss="modal" aria-label="Close">
			  <span aria-hidden="true">X</span>
			</button>
		  </div>
		  <div class="modal-body">
				Tus datos personales fueron cargados con éxito. Te invitamos en breve a participar de nuestro evento virtual.			
		  </div>
		</div>
...
?>
<!-- Modal de login -->
<div class="modal" id="tuc_modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
	   ...
	   <div class="modal-content">
		  ...
		  <div class="modal-body">
				La dirección de correo <b><?php echo $_GET['emailyaexiste']; ?></b>	ya esta registrada. Por favor, utiliza otra dirección de correo.		
		  </div>
		</div>
...
<script src="assets/js/regresiva.js"></script>
...
$(document).ready(function() {
	...
	?>
	$('#tuc_modal').show();
	$('#tuc_modal .close').click(function(event){
		$('#tuc_modal').hide();
	});
	<?php
	}
